...
engTokenize = get_tokenizer('spacy', language='en_core_web_sm')

zhTokenize = get_tokenizer('spacy', language='zh_core_web_sm')

# %%
# Above function accepts a text and returns a list of words
# as shown below:

print(engTokenize("Got it?"))
print(zhTokenize("懂了吗？"))
...
def applyPadding(pair_of_sequences):
    text_tranform = T.Sequential(
        T.ToTensor(0),
        T.PadTransform(max_length=64, pad_value=0)
    )
